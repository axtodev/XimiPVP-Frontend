...
const handleSubmit = async (e) => {
  ...
  function isStaffUser(roles = []) {
    return roles.some(roleId =>
      ["68f151d8bde29ee6d2793e1c", "68f151d8bde29ee6d2793e21", "68f151d8bde29ee6d2793e25", "68f151d8bde29ee6d2793e28"].includes(roleId)
    );
  }
          ...
          <ul className="reply-list">
            {sortedReplies.length === 0 ? (
              ...
              sortedReplies.map(r => {
                ...
                const isVip = roles.includes("68f151d8bde29ee6d2793e2e");
                const isMedia = roles.includes("68f151d8bde29ee6d2793e31");
                    ...
                    <div className="reply-author-container">
                      ...
                      <p className="reply-author">
                        {roles.map((roleId, index) => {
                          ...
                          if (roleId === "68f151d8bde29ee6d2793e1c") {
                            roleName = "[Owner]";
                            roleClass = "owner";
                          } else if (roleId === "68f151d8bde29ee6d2793e21") { 
                            roleName = "[Admin]";
                            roleClass = "admin";
                            ...
                            roleName = "[Mod]";
                            roleClass = "mod";
                          } else if (roleId === "68f151d8bde29ee6d2793e2b") {
                            roleName = "[Builder]";
                            roleClass = "builder";
                          }

                          // Nascondi il ruolo "Utente" di default
                          if (roleId === "68f151d8bde29ee6d2793e34") return null;
